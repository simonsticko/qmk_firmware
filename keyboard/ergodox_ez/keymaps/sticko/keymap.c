...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_UP,   KC_7,   NO_LBRC, NO_RBRC, NO_CIRC, KC_F12,
                KC_DOWN, KC_4,   NO_LCBR, NO_RCBR, SE_ASTR, KC_TRNS,
       KC_TRNS, KC_AMPR, KC_1,   NO_LESS, NO_GRTR, CTL_T(NO_BSLS),KC_TRNS,
